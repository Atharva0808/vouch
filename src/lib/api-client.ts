...
// ======== AI Creator Recommendation APIs ========
...
export interface RecommendationResponse {
    ...
    top_creators: ScoredCreator[];
    generated_at: string;
}

/** Run AI automated creator recommendation engine */
export async function discoverRecommendations(params: {
    category: string;
    audience_age?: string;
    budget?: number;
    campaign_goal?: string;
    ...
    return apiFetch<RecommendationResponse>("/api/recommendations/discover", {
        method: "POST",
        body: JSON.stringify(params),
    });
}
